...
func (suite *TMBDTestSuite) TestGetGuestSessionRatedMovies() {
	...
	suite.Nil(err)
	genres, err := suite.GetGuestSessionRatedMovies(gs.GuestSessionID, o)
	suite.Nil(err)
	suite.NotNil(genres)
}
...
func (suite *TMBDTestSuite) TestGetGuestSessionRatedTVShows() {
	...
	gs, err := suite.CreateGuestSession()
	suite.Nil(err)
	genres, err := suite.GetGuestSessionRatedTVShows(gs.GuestSessionID, o)
	suite.Nil(err)
	suite.NotNil(genres)
}
...
func (suite *TMBDTestSuite) TestGetGuestSessionRatedTVEpisodes() {
	...
	gs, err := suite.CreateGuestSession()
	suite.Nil(err)
	genres, err := suite.GetGuestSessionRatedTVEpisodes(gs.GuestSessionID, o)
	suite.Nil(err)
	suite.NotNil(genres)
}
