...
type TMDBClient interface {
	AddMovie(int, *ListMedia) (*Response, error)
	AddToWatchlist(int, *AccountWatchlist) (*Response, error)
	ClearList(int, bool) (*Response, error)
	CreateGuestSession() (*RequestToken, error)
	CreateList(*ListCreate) (*ListResponse, error)
	CreateRequestToken() (*RequestToken, error)
	DeleteList(int) (*Response, error)
	DeleteMovieRating(int, map[string]string) (*Response, error)
	DeleteTVShowRating(int, map[string]string) (*Response, error)
	...
	GetCollectionDetails(int, map[string]string) (*CollectionDetails, error)
	GetCollectionImages(int, map[string]string) (*CollectionImages, error)
	GetCollectionTranslations(int, map[string]string) (*CollectionTranslations, error)
	GetCompanyAlternativeNames(int) (*CompanyAlternativeNames, error)
	GetCompanyDetails(int) (*CompanyDetails, error)
	GetCompanyImages(int) (*CompanyImages, error)
	...
	GetCreatedLists(int, map[string]string) (*AccountCreatedLists, error)
	...
	GetFavoriteMovies(int, map[string]string) (*AccountFavoriteMovies, error)
	GetFavoriteTVShows(int, map[string]string) (*AccountFavoriteTVShows, error)
	...
	GetKeywordDetails(int) (*KeywordDetails, error)
	GetKeywordMovies(int, map[string]string) (*KeywordMovies, error)
	...
	GetMovieChanges(int, map[string]string) (*MovieChanges, error)
	GetMovieCredits(int, map[string]string) (*MovieCredits, error)
